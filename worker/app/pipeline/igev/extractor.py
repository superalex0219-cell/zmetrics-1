# Vendored from https://github.com/gangweix/IGEV-plusplus (MIT, see LICENSE).
# Patched: package-relative imports; Feature() works with both timm<=0.6 (separate
# act1) and timm>=0.7 (activation fused into bn1); no ImageNet weight download at
# construction — the IGEV checkpoint overwrites everything via load_state_dict.
import torch
import torch.nn as nn
import torch.nn.functional as F
from app.pipeline.igev.submodule import *
import timm
...
class Feature(SubModule):
    def __init__(self):
        ...
        self.bn1 = model.bn1
        # timm>=0.7 fuses the activation into bn1 (BatchNormAct2d) and drops act1
